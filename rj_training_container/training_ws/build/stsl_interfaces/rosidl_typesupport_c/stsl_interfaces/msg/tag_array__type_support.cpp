...
static const _TagArray_type_support_symbol_names_t _TagArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stsl_interfaces, msg, TagArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, stsl_interfaces, msg, TagArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, stsl_interfaces, msg, TagArray)() {
  return &::stsl_interfaces::msg::rosidl_typesupport_c::TagArray_message_type_support_handle;
}
