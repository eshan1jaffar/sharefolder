...
static const _MineralDepositSample_type_support_symbol_names_t _MineralDepositSample_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stsl_interfaces, msg, MineralDepositSample)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, stsl_interfaces, msg, MineralDepositSample)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, stsl_interfaces, msg, MineralDepositSample)() {
  return &::stsl_interfaces::msg::rosidl_typesupport_c::MineralDepositSample_message_type_support_handle;
}
