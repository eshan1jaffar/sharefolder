...
static const _MineralDepositArray_type_support_symbol_names_t _MineralDepositArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stsl_interfaces, msg, MineralDepositArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, stsl_interfaces, msg, MineralDepositArray)),
  }
};
...
{
  return &::stsl_interfaces::msg::rosidl_typesupport_cpp::MineralDepositArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, stsl_interfaces, msg, MineralDepositArray)() {
  return get_message_type_support_handle<stsl_interfaces::msg::MineralDepositArray>();
}
