...
#include "stsl_interfaces/action/detail/execute_mission__rosidl_typesupport_fastrtps_c.h"
...
using _ExecuteMission_Goal__ros_msg_type = stsl_interfaces__action__ExecuteMission_Goal;
...
size_t get_serialized_size_stsl_interfaces__action__ExecuteMission_Goal(
  const void * untyped_ros_message,
...
static uint32_t _ExecuteMission_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_stsl_interfaces__action__ExecuteMission_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t max_serialized_size_stsl_interfaces__action__ExecuteMission_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stsl_interfaces__action__ExecuteMission_Goal;
    is_plain =
      (
...
static size_t _ExecuteMission_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stsl_interfaces__action__ExecuteMission_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stsl_interfaces, action, ExecuteMission_Goal)() {
...
using _ExecuteMission_Result__ros_msg_type = stsl_interfaces__action__ExecuteMission_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t get_serialized_size_stsl_interfaces__action__ExecuteMission_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_Result__ros_msg_type * ros_message = static_cast<const _ExecuteMission_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_stsl_interfaces__action__ExecuteMission_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t max_serialized_size_stsl_interfaces__action__ExecuteMission_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces__action__ExecuteMission_Result;
    is_plain =
      (
      offsetof(DataType, structure_needs_at_least_one_member) +
      last_member_size
...
static size_t _ExecuteMission_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stsl_interfaces__action__ExecuteMission_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stsl_interfaces, action, ExecuteMission_Result)() {
...
using _ExecuteMission_Feedback__ros_msg_type = stsl_interfaces__action__ExecuteMission_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t get_serialized_size_stsl_interfaces__action__ExecuteMission_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_Feedback__ros_msg_type * ros_message = static_cast<const _ExecuteMission_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_stsl_interfaces__action__ExecuteMission_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t max_serialized_size_stsl_interfaces__action__ExecuteMission_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces__action__ExecuteMission_Feedback;
    is_plain =
      (
      offsetof(DataType, structure_needs_at_least_one_member) +
      last_member_size
...
static size_t _ExecuteMission_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stsl_interfaces__action__ExecuteMission_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stsl_interfaces, action, ExecuteMission_Feedback)() {
...
// already included above
// #include "stsl_interfaces/action/detail/execute_mission__functions.h"  // goal
...
using _ExecuteMission_SendGoal_Request__ros_msg_type = stsl_interfaces__action__ExecuteMission_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, stsl_interfaces, action, ExecuteMission_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t get_serialized_size_stsl_interfaces__action__ExecuteMission_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _ExecuteMission_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_stsl_interfaces__action__ExecuteMission_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_stsl_interfaces__action__ExecuteMission_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t max_serialized_size_stsl_interfaces__action__ExecuteMission_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_stsl_interfaces__action__ExecuteMission_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces__action__ExecuteMission_SendGoal_Request;
    is_plain =
      (
...
static size_t _ExecuteMission_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stsl_interfaces__action__ExecuteMission_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stsl_interfaces, action, ExecuteMission_SendGoal_Request)() {
...
using _ExecuteMission_SendGoal_Response__ros_msg_type = stsl_interfaces__action__ExecuteMission_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t get_serialized_size_stsl_interfaces__action__ExecuteMission_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _ExecuteMission_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_stsl_interfaces__action__ExecuteMission_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t max_serialized_size_stsl_interfaces__action__ExecuteMission_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces__action__ExecuteMission_SendGoal_Response;
    is_plain =
      (
...
static size_t _ExecuteMission_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stsl_interfaces__action__ExecuteMission_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stsl_interfaces, action, ExecuteMission_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stsl_interfaces, action, ExecuteMission_SendGoal)() {
...
using _ExecuteMission_GetResult_Request__ros_msg_type = stsl_interfaces__action__ExecuteMission_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t get_serialized_size_stsl_interfaces__action__ExecuteMission_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_GetResult_Request__ros_msg_type * ros_message = static_cast<const _ExecuteMission_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_stsl_interfaces__action__ExecuteMission_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t max_serialized_size_stsl_interfaces__action__ExecuteMission_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces__action__ExecuteMission_GetResult_Request;
    is_plain =
      (
...
static size_t _ExecuteMission_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stsl_interfaces__action__ExecuteMission_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stsl_interfaces, action, ExecuteMission_GetResult_Request)() {
...
// already included above
// #include "stsl_interfaces/action/detail/execute_mission__functions.h"  // result
...
using _ExecuteMission_GetResult_Response__ros_msg_type = stsl_interfaces__action__ExecuteMission_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, stsl_interfaces, action, ExecuteMission_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t get_serialized_size_stsl_interfaces__action__ExecuteMission_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_GetResult_Response__ros_msg_type * ros_message = static_cast<const _ExecuteMission_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_stsl_interfaces__action__ExecuteMission_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_stsl_interfaces__action__ExecuteMission_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t max_serialized_size_stsl_interfaces__action__ExecuteMission_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_stsl_interfaces__action__ExecuteMission_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces__action__ExecuteMission_GetResult_Response;
    is_plain =
      (
...
static size_t _ExecuteMission_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stsl_interfaces__action__ExecuteMission_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stsl_interfaces, action, ExecuteMission_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stsl_interfaces, action, ExecuteMission_GetResult)() {
...
// already included above
// #include "stsl_interfaces/action/detail/execute_mission__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _ExecuteMission_FeedbackMessage__ros_msg_type = stsl_interfaces__action__ExecuteMission_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, stsl_interfaces, action, ExecuteMission_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t get_serialized_size_stsl_interfaces__action__ExecuteMission_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteMission_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _ExecuteMission_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_stsl_interfaces__action__ExecuteMission_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_stsl_interfaces__action__ExecuteMission_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stsl_interfaces
size_t max_serialized_size_stsl_interfaces__action__ExecuteMission_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_stsl_interfaces__action__ExecuteMission_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces__action__ExecuteMission_FeedbackMessage;
    is_plain =
      (
...
static size_t _ExecuteMission_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stsl_interfaces__action__ExecuteMission_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stsl_interfaces, action, ExecuteMission_FeedbackMessage)() {
