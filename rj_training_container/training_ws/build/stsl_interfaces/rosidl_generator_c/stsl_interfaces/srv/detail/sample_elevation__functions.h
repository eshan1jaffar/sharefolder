...
#ifndef STSL_INTERFACES__SRV__DETAIL__SAMPLE_ELEVATION__FUNCTIONS_H_
#define STSL_INTERFACES__SRV__DETAIL__SAMPLE_ELEVATION__FUNCTIONS_H_
...
/// Initialize srv/SampleElevation message.
/**
...
/// Finalize srv/SampleElevation message.
/**
...
/// Create srv/SampleElevation message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * stsl_interfaces__srv__SampleElevation_Request__init().
...
/// Destroy srv/SampleElevation message.
/**
 * It calls
 * stsl_interfaces__srv__SampleElevation_Request__fini()
...
/// Check for srv/SampleElevation message equality.
/**
...
/// Copy a srv/SampleElevation message.
/**
...
/// Initialize array of srv/SampleElevation messages.
/**
...
/// Finalize array of srv/SampleElevation messages.
/**
 * It calls
 * stsl_interfaces__srv__SampleElevation_Request__fini()
...
/// Create array of srv/SampleElevation messages.
/**
 * It allocates the memory for the array and calls
 * stsl_interfaces__srv__SampleElevation_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SampleElevation messages.
/**
 * It calls
 * stsl_interfaces__srv__SampleElevation_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SampleElevation message array equality.
/**
...
/// Copy an array of srv/SampleElevation messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * stsl_interfaces__srv__SampleElevation_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_stsl_interfaces
...
/**
 * It calls
 * stsl_interfaces__srv__SampleElevation_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_stsl_interfaces
...
/**
 * It allocates the memory for the array and calls
 * stsl_interfaces__srv__SampleElevation_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_stsl_interfaces
...
/**
 * It calls
 * stsl_interfaces__srv__SampleElevation_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // STSL_INTERFACES__SRV__DETAIL__SAMPLE_ELEVATION__FUNCTIONS_H_
