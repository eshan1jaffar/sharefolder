...
#include "stsl_interfaces/action/detail/execute_mission__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const stsl_interfaces::action::ExecuteMission_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stsl_interfaces::action::ExecuteMission_Goal & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stsl_interfaces::action::ExecuteMission_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stsl_interfaces::action::ExecuteMission_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stsl_interfaces::action::ExecuteMission_Goal *>(
    untyped_ros_message);
...
{
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stsl_interfaces, action, ExecuteMission_Goal)() {
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_stsl_interfaces
cdr_serialize(
  const stsl_interfaces::action::ExecuteMission_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: structure_needs_at_least_one_member
  cdr << ros_message.structure_needs_at_least_one_member;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stsl_interfaces::action::ExecuteMission_Result & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces::action::ExecuteMission_Result;
    is_plain =
      (
      offsetof(DataType, structure_needs_at_least_one_member) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const stsl_interfaces::action::ExecuteMission_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<stsl_interfaces::action::ExecuteMission_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stsl_interfaces, action, ExecuteMission_Result)() {
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_stsl_interfaces
cdr_serialize(
  const stsl_interfaces::action::ExecuteMission_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: structure_needs_at_least_one_member
  cdr << ros_message.structure_needs_at_least_one_member;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stsl_interfaces::action::ExecuteMission_Feedback & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces::action::ExecuteMission_Feedback;
    is_plain =
      (
      offsetof(DataType, structure_needs_at_least_one_member) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const stsl_interfaces::action::ExecuteMission_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<stsl_interfaces::action::ExecuteMission_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stsl_interfaces, action, ExecuteMission_Feedback)() {
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_Feedback__handle;
}
...
// functions for stsl_interfaces::action::ExecuteMission_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_stsl_interfaces
cdr_serialize(
  const stsl_interfaces::action::ExecuteMission_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stsl_interfaces::action::ExecuteMission_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        stsl_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_ExecuteMission_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces::action::ExecuteMission_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stsl_interfaces::action::ExecuteMission_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<stsl_interfaces::action::ExecuteMission_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stsl_interfaces, action, ExecuteMission_SendGoal_Request)() {
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_stsl_interfaces
cdr_serialize(
  const stsl_interfaces::action::ExecuteMission_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stsl_interfaces::action::ExecuteMission_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces::action::ExecuteMission_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stsl_interfaces::action::ExecuteMission_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<stsl_interfaces::action::ExecuteMission_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stsl_interfaces, action, ExecuteMission_SendGoal_Response)() {
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_SendGoal_Response__handle;
}
...
{
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stsl_interfaces, action, ExecuteMission_SendGoal)() {
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_stsl_interfaces
cdr_serialize(
  const stsl_interfaces::action::ExecuteMission_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stsl_interfaces::action::ExecuteMission_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces::action::ExecuteMission_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stsl_interfaces::action::ExecuteMission_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<stsl_interfaces::action::ExecuteMission_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stsl_interfaces, action, ExecuteMission_GetResult_Request)() {
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for stsl_interfaces::action::ExecuteMission_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_stsl_interfaces
cdr_serialize(
  const stsl_interfaces::action::ExecuteMission_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stsl_interfaces::action::ExecuteMission_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        stsl_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_ExecuteMission_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces::action::ExecuteMission_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stsl_interfaces::action::ExecuteMission_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<stsl_interfaces::action::ExecuteMission_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stsl_interfaces, action, ExecuteMission_GetResult_Response)() {
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_GetResult_Response__handle;
}
...
{
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stsl_interfaces, action, ExecuteMission_GetResult)() {
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_GetResult__handle;
}
...
// functions for stsl_interfaces::action::ExecuteMission_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_stsl_interfaces
cdr_serialize(
  const stsl_interfaces::action::ExecuteMission_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stsl_interfaces::action::ExecuteMission_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        stsl_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_ExecuteMission_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = stsl_interfaces::action::ExecuteMission_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stsl_interfaces::action::ExecuteMission_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<stsl_interfaces::action::ExecuteMission_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stsl_interfaces, action, ExecuteMission_FeedbackMessage)() {
  return &stsl_interfaces::action::typesupport_fastrtps_cpp::_ExecuteMission_FeedbackMessage__handle;
}
