...
#include "stsl_interfaces/msg/detail/tag__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const stsl_interfaces::msg::Tag & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stsl_interfaces::msg::Tag & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stsl_interfaces::msg::Tag;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stsl_interfaces::msg::Tag *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stsl_interfaces::msg::Tag *>(
    untyped_ros_message);
...
{
  return &stsl_interfaces::msg::typesupport_fastrtps_cpp::_Tag__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stsl_interfaces, msg, Tag)() {
  return &stsl_interfaces::msg::typesupport_fastrtps_cpp::_Tag__handle;
}
