...
#define NODE_MAIN_LOGGER_NAME "aruco_marker_visualizer"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libstsl_aruco_tags.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<stsl_aruco_tags::ArucoMarkerVisualizer>";
