...
bool joystick_msgs__msg__velocity_pair__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("joystick_msgs.msg._velocity_pair.VelocityPair", full_classname_dest, 45) == 0);
  }
  joystick_msgs__msg__VelocityPair * ros_message = _ros_message;
  {  // header
...
PyObject * joystick_msgs__msg__velocity_pair__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("joystick_msgs.msg._velocity_pair");
