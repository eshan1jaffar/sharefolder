...
#define NODE_MAIN_LOGGER_NAME "localization_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblocalization_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<localization::ParticleFilterLocalizer>";
