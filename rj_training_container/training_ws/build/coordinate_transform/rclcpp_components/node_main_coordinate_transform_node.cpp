...
#define NODE_MAIN_LOGGER_NAME "coordinate_transform_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcoordinate_transform_components.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<coordinate_transform::CoordinateTransformComponent>";
