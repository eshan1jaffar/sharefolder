...
#define NODE_MAIN_LOGGER_NAME "mineral_deposit_tracker"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmineral_deposit_tracking.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mineral_deposit_tracking::MineralDepositTracker>";
