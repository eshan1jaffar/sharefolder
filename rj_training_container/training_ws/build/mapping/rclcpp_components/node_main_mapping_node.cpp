...
#define NODE_MAIN_LOGGER_NAME "mapping_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmapping.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mapping::MappingNode>";
