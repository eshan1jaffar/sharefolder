...
#define NODE_MAIN_LOGGER_NAME "elevation_server_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libelevation_server_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<elevation_server::ElevationServer>";
