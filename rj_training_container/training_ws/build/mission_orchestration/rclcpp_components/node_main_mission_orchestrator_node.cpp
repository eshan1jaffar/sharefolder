...
#define NODE_MAIN_LOGGER_NAME "mission_orchestrator_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmission_orchestration_components.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mission_orchestration::MissionOrchestrator>";
