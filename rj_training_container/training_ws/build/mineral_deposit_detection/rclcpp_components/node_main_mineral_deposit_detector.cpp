...
#define NODE_MAIN_LOGGER_NAME "mineral_deposit_detector"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmineral_deposit_detection.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mineral_deposit_detection::MineralDepositDetector>";
