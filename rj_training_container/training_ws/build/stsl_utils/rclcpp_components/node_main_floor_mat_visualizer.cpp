...
#define NODE_MAIN_LOGGER_NAME "floor_mat_visualizer"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libstsl_utils.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<stsl_utils::FloorMatVisualizer>";
