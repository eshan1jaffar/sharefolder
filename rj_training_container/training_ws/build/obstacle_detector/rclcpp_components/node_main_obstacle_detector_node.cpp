...
#define NODE_MAIN_LOGGER_NAME "obstacle_detector_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libobstacle_detector.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<obstacle_detector::ObstacleDetector>";
