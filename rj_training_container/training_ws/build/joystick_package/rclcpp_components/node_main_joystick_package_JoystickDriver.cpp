...
#define NODE_MAIN_LOGGER_NAME "joystick_package_JoystickDriver"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libjoystick_package.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<joystick_driver::JoystickDriver>";
