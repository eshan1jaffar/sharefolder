...
#define NODE_MAIN_LOGGER_NAME "peak_finder_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpeak_finder_components.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<peak_finder::PeakFinderComponent>";
