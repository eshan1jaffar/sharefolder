...
{
  new (message_memory) joystick_msgs::msg::VelocityPair(_init);
}

void VelocityPair_fini_function(void * message_memory)
{
  auto typed_message = static_cast<joystick_msgs::msg::VelocityPair *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VelocityPair_message_member_array[4] = {
  {
    ...
    offsetof(joystick_msgs::msg::VelocityPair, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(joystick_msgs::msg::VelocityPair, left_velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(joystick_msgs::msg::VelocityPair, right_velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(joystick_msgs::msg::VelocityPair, duration),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers VelocityPair_message_members = {
  "joystick_msgs::msg",  // message namespace
  "VelocityPair",  // message name
  4,  // number of fields
  sizeof(joystick_msgs::msg::VelocityPair),
...
{
  return &::joystick_msgs::msg::rosidl_typesupport_introspection_cpp::VelocityPair_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, joystick_msgs, msg, VelocityPair)() {
  return &::joystick_msgs::msg::rosidl_typesupport_introspection_cpp::VelocityPair_message_type_support_handle;
}
