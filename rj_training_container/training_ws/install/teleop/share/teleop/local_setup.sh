...
: ${AMENT_CURRENT_PREFIX:="/home/ubuntu/rj_training_container/training_ws/install/teleop"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/teleop/environment/library_path.sh"
