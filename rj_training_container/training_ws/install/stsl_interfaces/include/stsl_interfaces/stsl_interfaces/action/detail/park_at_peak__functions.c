...
stsl_interfaces__action__ParkAtPeak_Goal__create()
{
  ...
  stsl_interfaces__action__ParkAtPeak_Goal * msg = (stsl_interfaces__action__ParkAtPeak_Goal *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_Goal__Sequence__init(stsl_interfaces__action__ParkAtPeak_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (stsl_interfaces__action__ParkAtPeak_Goal *)allocator.zero_allocate(size, sizeof(stsl_interfaces__action__ParkAtPeak_Goal), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_Goal__Sequence * array = (stsl_interfaces__action__ParkAtPeak_Goal__Sequence *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_Goal__Sequence__are_equal(const stsl_interfaces__action__ParkAtPeak_Goal__Sequence * lhs, const stsl_interfaces__action__ParkAtPeak_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stsl_interfaces__action__ParkAtPeak_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stsl_interfaces__action__ParkAtPeak_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stsl_interfaces__action__ParkAtPeak_Goal * data =
      (stsl_interfaces__action__ParkAtPeak_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stsl_interfaces__action__ParkAtPeak_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stsl_interfaces__action__ParkAtPeak_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_Result * msg = (stsl_interfaces__action__ParkAtPeak_Result *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_Result__Sequence__init(stsl_interfaces__action__ParkAtPeak_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (stsl_interfaces__action__ParkAtPeak_Result *)allocator.zero_allocate(size, sizeof(stsl_interfaces__action__ParkAtPeak_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_Result__Sequence * array = (stsl_interfaces__action__ParkAtPeak_Result__Sequence *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_Result__Sequence__are_equal(const stsl_interfaces__action__ParkAtPeak_Result__Sequence * lhs, const stsl_interfaces__action__ParkAtPeak_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stsl_interfaces__action__ParkAtPeak_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stsl_interfaces__action__ParkAtPeak_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stsl_interfaces__action__ParkAtPeak_Result * data =
      (stsl_interfaces__action__ParkAtPeak_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stsl_interfaces__action__ParkAtPeak_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stsl_interfaces__action__ParkAtPeak_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_Feedback * msg = (stsl_interfaces__action__ParkAtPeak_Feedback *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_Feedback__Sequence__init(stsl_interfaces__action__ParkAtPeak_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (stsl_interfaces__action__ParkAtPeak_Feedback *)allocator.zero_allocate(size, sizeof(stsl_interfaces__action__ParkAtPeak_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_Feedback__Sequence * array = (stsl_interfaces__action__ParkAtPeak_Feedback__Sequence *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_Feedback__Sequence__are_equal(const stsl_interfaces__action__ParkAtPeak_Feedback__Sequence * lhs, const stsl_interfaces__action__ParkAtPeak_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stsl_interfaces__action__ParkAtPeak_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stsl_interfaces__action__ParkAtPeak_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stsl_interfaces__action__ParkAtPeak_Feedback * data =
      (stsl_interfaces__action__ParkAtPeak_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stsl_interfaces__action__ParkAtPeak_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stsl_interfaces__action__ParkAtPeak_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
stsl_interfaces__action__ParkAtPeak_SendGoal_Request__are_equal(const stsl_interfaces__action__ParkAtPeak_SendGoal_Request * lhs, const stsl_interfaces__action__ParkAtPeak_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!stsl_interfaces__action__ParkAtPeak_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_SendGoal_Request * msg = (stsl_interfaces__action__ParkAtPeak_SendGoal_Request *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_SendGoal_Request__Sequence__init(stsl_interfaces__action__ParkAtPeak_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (stsl_interfaces__action__ParkAtPeak_SendGoal_Request *)allocator.zero_allocate(size, sizeof(stsl_interfaces__action__ParkAtPeak_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_SendGoal_Request__Sequence * array = (stsl_interfaces__action__ParkAtPeak_SendGoal_Request__Sequence *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_SendGoal_Request__Sequence__are_equal(const stsl_interfaces__action__ParkAtPeak_SendGoal_Request__Sequence * lhs, const stsl_interfaces__action__ParkAtPeak_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stsl_interfaces__action__ParkAtPeak_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stsl_interfaces__action__ParkAtPeak_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stsl_interfaces__action__ParkAtPeak_SendGoal_Request * data =
      (stsl_interfaces__action__ParkAtPeak_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stsl_interfaces__action__ParkAtPeak_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stsl_interfaces__action__ParkAtPeak_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_SendGoal_Response * msg = (stsl_interfaces__action__ParkAtPeak_SendGoal_Response *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_SendGoal_Response__Sequence__init(stsl_interfaces__action__ParkAtPeak_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (stsl_interfaces__action__ParkAtPeak_SendGoal_Response *)allocator.zero_allocate(size, sizeof(stsl_interfaces__action__ParkAtPeak_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_SendGoal_Response__Sequence * array = (stsl_interfaces__action__ParkAtPeak_SendGoal_Response__Sequence *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_SendGoal_Response__Sequence__are_equal(const stsl_interfaces__action__ParkAtPeak_SendGoal_Response__Sequence * lhs, const stsl_interfaces__action__ParkAtPeak_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stsl_interfaces__action__ParkAtPeak_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stsl_interfaces__action__ParkAtPeak_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stsl_interfaces__action__ParkAtPeak_SendGoal_Response * data =
      (stsl_interfaces__action__ParkAtPeak_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stsl_interfaces__action__ParkAtPeak_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stsl_interfaces__action__ParkAtPeak_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_GetResult_Request * msg = (stsl_interfaces__action__ParkAtPeak_GetResult_Request *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_GetResult_Request__Sequence__init(stsl_interfaces__action__ParkAtPeak_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (stsl_interfaces__action__ParkAtPeak_GetResult_Request *)allocator.zero_allocate(size, sizeof(stsl_interfaces__action__ParkAtPeak_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_GetResult_Request__Sequence * array = (stsl_interfaces__action__ParkAtPeak_GetResult_Request__Sequence *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_GetResult_Request__Sequence__are_equal(const stsl_interfaces__action__ParkAtPeak_GetResult_Request__Sequence * lhs, const stsl_interfaces__action__ParkAtPeak_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stsl_interfaces__action__ParkAtPeak_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stsl_interfaces__action__ParkAtPeak_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stsl_interfaces__action__ParkAtPeak_GetResult_Request * data =
      (stsl_interfaces__action__ParkAtPeak_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stsl_interfaces__action__ParkAtPeak_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stsl_interfaces__action__ParkAtPeak_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
stsl_interfaces__action__ParkAtPeak_GetResult_Response__are_equal(const stsl_interfaces__action__ParkAtPeak_GetResult_Response * lhs, const stsl_interfaces__action__ParkAtPeak_GetResult_Response * rhs)
{
  ...
  // result
  if (!stsl_interfaces__action__ParkAtPeak_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_GetResult_Response * msg = (stsl_interfaces__action__ParkAtPeak_GetResult_Response *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_GetResult_Response__Sequence__init(stsl_interfaces__action__ParkAtPeak_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (stsl_interfaces__action__ParkAtPeak_GetResult_Response *)allocator.zero_allocate(size, sizeof(stsl_interfaces__action__ParkAtPeak_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_GetResult_Response__Sequence * array = (stsl_interfaces__action__ParkAtPeak_GetResult_Response__Sequence *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_GetResult_Response__Sequence__are_equal(const stsl_interfaces__action__ParkAtPeak_GetResult_Response__Sequence * lhs, const stsl_interfaces__action__ParkAtPeak_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stsl_interfaces__action__ParkAtPeak_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stsl_interfaces__action__ParkAtPeak_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stsl_interfaces__action__ParkAtPeak_GetResult_Response * data =
      (stsl_interfaces__action__ParkAtPeak_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stsl_interfaces__action__ParkAtPeak_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stsl_interfaces__action__ParkAtPeak_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
stsl_interfaces__action__ParkAtPeak_FeedbackMessage__are_equal(const stsl_interfaces__action__ParkAtPeak_FeedbackMessage * lhs, const stsl_interfaces__action__ParkAtPeak_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!stsl_interfaces__action__ParkAtPeak_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_FeedbackMessage * msg = (stsl_interfaces__action__ParkAtPeak_FeedbackMessage *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_FeedbackMessage__Sequence__init(stsl_interfaces__action__ParkAtPeak_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (stsl_interfaces__action__ParkAtPeak_FeedbackMessage *)allocator.zero_allocate(size, sizeof(stsl_interfaces__action__ParkAtPeak_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stsl_interfaces__action__ParkAtPeak_FeedbackMessage__Sequence * array = (stsl_interfaces__action__ParkAtPeak_FeedbackMessage__Sequence *)allocator.allocate(sizeof(stsl_interfaces__action__ParkAtPeak_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
stsl_interfaces__action__ParkAtPeak_FeedbackMessage__Sequence__are_equal(const stsl_interfaces__action__ParkAtPeak_FeedbackMessage__Sequence * lhs, const stsl_interfaces__action__ParkAtPeak_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stsl_interfaces__action__ParkAtPeak_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stsl_interfaces__action__ParkAtPeak_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stsl_interfaces__action__ParkAtPeak_FeedbackMessage * data =
      (stsl_interfaces__action__ParkAtPeak_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stsl_interfaces__action__ParkAtPeak_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stsl_interfaces__action__ParkAtPeak_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stsl_interfaces__action__ParkAtPeak_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
