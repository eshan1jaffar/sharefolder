    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'stsl_interfaces.action.ExecuteMission_Goal')
            logger.debug(
...
class Metaclass_ExecuteMission_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'stsl_interfaces.action.ExecuteMission_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_ExecuteMission_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'stsl_interfaces.action.ExecuteMission_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_ExecuteMission_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from stsl_interfaces.action import ExecuteMission
...
class ExecuteMission_SendGoal_Request(metaclass=Metaclass_ExecuteMission_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'stsl_interfaces/ExecuteMission_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['stsl_interfaces', 'action'], 'ExecuteMission_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from stsl_interfaces.action._execute_mission import ExecuteMission_Goal
...
class Metaclass_ExecuteMission_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'stsl_interfaces.action.ExecuteMission_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from stsl_interfaces.action import _execute_mission
...
class ExecuteMission_SendGoal(metaclass=Metaclass_ExecuteMission_SendGoal):
    from stsl_interfaces.action._execute_mission import ExecuteMission_SendGoal_Request as Request
    from stsl_interfaces.action._execute_mission import ExecuteMission_SendGoal_Response as Response
...
class ExecuteMission_GetResult_Response(metaclass=Metaclass_ExecuteMission_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'stsl_interfaces/ExecuteMission_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['stsl_interfaces', 'action'], 'ExecuteMission_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from stsl_interfaces.action._execute_mission import ExecuteMission_Result
...
class Metaclass_ExecuteMission_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'stsl_interfaces.action.ExecuteMission_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission_GetResult(metaclass=Metaclass_ExecuteMission_GetResult):
    from stsl_interfaces.action._execute_mission import ExecuteMission_GetResult_Request as Request
    from stsl_interfaces.action._execute_mission import ExecuteMission_GetResult_Response as Response
...
class Metaclass_ExecuteMission_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'stsl_interfaces.action.ExecuteMission_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission_FeedbackMessage(metaclass=Metaclass_ExecuteMission_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'stsl_interfaces/ExecuteMission_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['stsl_interfaces', 'action'], 'ExecuteMission_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from stsl_interfaces.action._execute_mission import ExecuteMission_Feedback
...
class Metaclass_ExecuteMission(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'stsl_interfaces.action.ExecuteMission')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMission(metaclass=Metaclass_ExecuteMission):
    ...
    from stsl_interfaces.action._execute_mission import ExecuteMission_Goal as Goal
    # The result message defined in the action definition.
    from stsl_interfaces.action._execute_mission import ExecuteMission_Result as Result
    # The feedback message defined in the action definition.
    from stsl_interfaces.action._execute_mission import ExecuteMission_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from stsl_interfaces.action._execute_mission import ExecuteMission_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from stsl_interfaces.action._execute_mission import ExecuteMission_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from stsl_interfaces.action._execute_mission import ExecuteMission_FeedbackMessage as FeedbackMessage
