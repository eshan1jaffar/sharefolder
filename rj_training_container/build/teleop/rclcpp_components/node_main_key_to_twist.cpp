...
#define NODE_MAIN_LOGGER_NAME "key_to_twist"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libteleop.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<key_to_twist::KeyToTwist>";
